"use client"
import { ClipboardCheck, Briefcase, BarChart } from "lucide-react";
  ...
  const highlights = [
    {
      ...
      text: "Hospital Leadership",
    },
    { icon: <Briefcase className="w-6 h-6" />, text: "Healthcare Management" },
    { icon: <BarChart className="w-6 h-6" />, text: "₹5-30 LPA Salary" },
  ];
