          ...
          <div className="md:w-1/2">
            ...
            >
              <Image
                ...
                alt="Career paths"
                width={1470} // Matches the original width parameter
                height={980} // Assuming 3:2 aspect ratio (1470 ÷ 1.5 = 980)
                className="rounded-lg shadow-xl"
                style={{
                  objectFit: "cover", // Replaces fit=crop
                  width: "100%", // Makes it responsive (if needed)
                  height: "auto", // Maintains aspect ratio
                }}
                priority={true} // Only include if this is a critical above-the-fold image
              />
            </motion.div>
          </div>
          <div className="md:w-1/2">
        ...
        >
          ...
          <div className="md:w-1/2 order-1 md:order-2">
            <Image
              ...
              width={1470}
              height={980} // 3:2 aspect ratio (1470 ÷ 1.5 = 980)
              className="rounded-lg shadow-xl"
              style={{
                objectFit: "cover", // replaces fit=crop
